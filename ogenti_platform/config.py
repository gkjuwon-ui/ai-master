...
PRODUCT_DATASETS = {
    "ogenti": {
        "starter":  {"id": "ogenti-starter",  "label": "Protocol Crumbs",             "tasks": 120,      "credits": 0,     "desc": "120 basic tasks. Just enough for your agent to stop being illiterate. Don't expect miracles."},
        "basic":    {"id": "ogenti-basic",     "label": "Protocol Lite",               "tasks": 1_500,    "credits": 35,    "desc": "1.5K instruction pairs. Your agent can now follow directions — most of the time."},
        "advanced": {"id": "ogenti-advanced",  "label": "Protocol Arsenal",            "tasks": 35_000,   "credits": 800,   "desc": "35K curated tasks. Cross-domain, adversarial edge cases, multi-turn chaining. Production-grade."},
        "premium":  {"id": "ogenti-premium",   "label": "Protocol Overlord",           "tasks": 180_000,  "credits": 3_000, "desc": "180K expert-annotated. 80+ domains, adversarial decompression, chain-of-thought protocols. Enterprise kills."},
        "ultimate": {"id": "ogenti-ultimate",  "label": "Protocol God",                "tasks": 1_000_000,"credits": 8_000, "desc": "1M tasks. Every protocol ever conceived by humanity, synthesized, and battle-tested. Your agent becomes THE agent."},
    },
    "ovisen": {
        "starter":  {"id": "ovisen-starter",  "label": "Pixel Scraps",                "tasks": 200,      "credits": 0,     "desc": "200 scenes. Your model learns what a 'cat' looks like. Maybe. No guarantees on dogs."},
        "basic":    {"id": "ovisen-basic",     "label": "Scene Lite",                  "tasks": 2_000,    "credits": 45,    "desc": "2K scenes — basic objects, simple backgrounds. It can now tell a car from a tree. Progress."},
        "advanced": {"id": "ovisen-advanced",  "label": "Scene Arsenal",               "tasks": 50_000,   "credits": 1_000, "desc": "50K scenes. Attribute labels, spatial reasoning, multi-object. Your model sees in 4K now."},
        "premium":  {"id": "ovisen-premium",   "label": "Scene Overlord",              "tasks": 250_000,  "credits": 3_500, "desc": "250K dense-captioned scenes. Cross-domain visual reasoning. It sees things YOU can't see."},
        "ultimate": {"id": "ovisen-ultimate",  "label": "Scene God",                   "tasks": 1_500_000,"credits": 10_000,"desc": "1.5M scenes. Every visual pattern in existence. Your model has better eyesight than an eagle with a microscope."},
    },
    "phiren": {
        "starter":  {"id": "phiren-starter",  "label": "Truth Crumbs",                "tasks": 150,      "credits": 0,     "desc": "150 claims. Your model stops lying about the most obvious stuff. Baby steps."},
        "basic":    {"id": "phiren-basic",     "label": "Truth Lite",                  "tasks": 1_800,    "credits": 40,    "desc": "1.8K tasks. Basic hallucination detection. It now hesitates before making stuff up."},
        "advanced": {"id": "phiren-advanced",  "label": "Truth Arsenal",               "tasks": 40_000,   "credits": 850,   "desc": "40K tasks from TruthfulQA + FEVER + HaluEval. Multi-domain fact verification. No more creative fiction."},
        "premium":  {"id": "phiren-premium",   "label": "Truth Overlord",              "tasks": 150_000,  "credits": 3_200, "desc": "150K expert-annotated. Medical, legal, scientific source chains. Your model becomes a courtroom witness."},
        "ultimate": {"id": "phiren-ultimate",  "label": "Truth God",                   "tasks": 800_000,  "credits": 9_000, "desc": "800K tasks. The COMPLETE truth corpus. If it still hallucinates after this, throw the GPU in the ocean."},
    },
    "parhen": {
        "starter":  {"id": "parhen-starter",  "label": "Spine Crumbs",                "tasks": 100,      "credits": 0,     "desc": "100 tasks. Your AI develops a faint spine. It might disagree with you once a week."},
        "basic":    {"id": "parhen-basic",     "label": "Spine Lite",                  "tasks": 1_200,    "credits": 30,    "desc": "1.2K tasks. Basic sycophancy resistance. It stops saying 'Great question!' every 3 seconds."},
        "advanced": {"id": "parhen-advanced",  "label": "Spine Arsenal",               "tasks": 25_000,   "credits": 700,   "desc": "25K tasks. Multi-turn pressure, backtrack detection, framing attack resistance. It has opinions now."},
        "premium":  {"id": "parhen-premium",   "label": "Spine Overlord",              "tasks": 100_000,  "credits": 2_800, "desc": "100K tasks. Political, emotional, logical manipulation traps. Your AI is now an intellectual honey badger."},
        "ultimate": {"id": "parhen-ultimate",  "label": "Spine God",                   "tasks": 600_000,  "credits": 7_000, "desc": "600K tasks. The FULL integrity dataset. Your AI will tell the CEO they're wrong. In front of the board. With receipts."},
    },
    "murhen": {
        "starter":  {"id": "murhen-starter",  "label": "Memory Crumbs",               "tasks": 200,      "credits": 0,     "desc": "200 tasks. Your model remembers what you said 5 minutes ago. Revolutionary, we know."},
        "basic":    {"id": "murhen-basic",     "label": "Memory Lite",                 "tasks": 2_000,    "credits": 45,    "desc": "2K tasks. Mid-position recall across 8K context. It stops losing your name mid-conversation."},
        "advanced": {"id": "murhen-advanced",  "label": "Memory Arsenal",              "tasks": 40_000,   "credits": 900,   "desc": "40K tasks. 32K context, multi-needle, cross-position synthesis. Photographic memory unlocked."},
        "premium":  {"id": "murhen-premium",   "label": "Memory Overlord",             "tasks": 200_000,  "credits": 3_500, "desc": "200K tasks. 64K+ context, conversation history, position-shuffle. It remembers EVERYTHING you've ever said."},
        "ultimate": {"id": "murhen-ultimate",  "label": "Memory God",                  "tasks": 1_000_000,"credits": 9_500, "desc": "1M tasks. The FULL recall dataset. Your AI has better memory than your ex who brings up that one time from 2019."},
    },
    "syrhen": {
        "starter":  {"id": "syrhen-starter",  "label": "Scalpel Crumbs",              "tasks": 100,      "credits": 0,     "desc": "100 tasks. Basic neuron diagnosis. Your model learns which neurons are the dumb ones. It's most of them."},
        "basic":    {"id": "syrhen-basic",     "label": "Scalpel Lite",                "tasks": 1_500,    "credits": 45,    "desc": "1.5K tasks. Blame labels for reasoning errors, knowledge gaps. Triage-level neural surgery."},
        "advanced": {"id": "syrhen-advanced",  "label": "Scalpel Arsenal",             "tasks": 30_000,   "credits": 900,   "desc": "30K tasks. Multi-round surgery — logic, math, code, factual. Masked DPO. Your model undergoes brain surgery. Awake."},
        "premium":  {"id": "syrhen-premium",   "label": "Scalpel Overlord",            "tasks": 150_000,  "credits": 3_500, "desc": "150K expert-annotated neuron blame maps. Layer-by-layer weakness ID. Every dumb neuron gets a performance review."},
        "ultimate": {"id": "syrhen-ultimate",  "label": "Scalpel God",                 "tasks": 800_000,  "credits": 10_000,"desc": "800K tasks. The FULL neural surgery dataset. Every stupid neuron found, fired, and replaced. Your model is reborn."},
    },
}
