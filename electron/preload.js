...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // Runtime Token (Central Server Mode)
  runtime: {
    saveToken: (token) => ipcRenderer.invoke('runtime:save-token', token),
    getToken: () => ipcRenderer.invoke('runtime:get-token'),
    getBackendUrl: () => ipcRenderer.invoke('runtime:get-backend-url'),
    isCentral: () => ipcRenderer.invoke('runtime:is-central'),
  },
