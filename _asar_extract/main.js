...
async function startServices() {
  ...
  // Load .env files from backend directory for SMTP and other config
  ...
  // SMTP keys (priority: electron-store > .env files > process.env > empty)
  ...
  // Stripe keys (priority: electron-store > .env files > process.env)
