"""Generate Colab-compatible notebook using nbformat (guaranteed valid JSON)."""
...
# ───────── Cell 2: GPU Check header ─────────
cells.append(nbf.v4.new_markdown_cell("## 0. GPU Check"))
...
# ───────── Cell 7: HF Login code ─────────
cells.append(nbf.v4.new_code_cell(
    'from huggingface_hub import login\n'
    'from google.colab import userdata\n'
    '\n'
    '# Option 1: Use Colab Secrets (recommended)\n'
    '# Go to the key icon on the left sidebar > Add "HF_TOKEN" secret\n'
    'try:\n'
...
# ───────── Cell 8: Clone header ─────────
cells.append(nbf.v4.new_markdown_cell("## 3. Clone Repository"))
...
# ───────── Cell 10: Config header ─────────
cells.append(nbf.v4.new_markdown_cell("## 4. Verify Config and Model Access"))
...
# ───────── Cell 12: Memory header ─────────
cells.append(nbf.v4.new_markdown_cell("## 5. Memory Estimation"))
...
# ───────── Cell 18: Monitor header ─────────
cells.append(nbf.v4.new_markdown_cell("## 8. Monitor Training Log"))

# ───────── Cell 19: Monitor code ─────────
cells.append(nbf.v4.new_code_cell(
    'import os\n'
    '\n'
...
# ───────── Cell 20: Analyze header ─────────
cells.append(nbf.v4.new_markdown_cell("## 9. Analyze Results"))

# ───────── Cell 21: Analyze code ─────────
cells.append(nbf.v4.new_code_cell(
    'import json, os, re\n'
    '\n'
...
# ───────── Cell 22: Curves header ─────────
cells.append(nbf.v4.new_markdown_cell("## Training Curves"))
...
# ── Write with nbformat (guaranteed valid) ──
OUTPUT = r"C:\Users\gkjuw\Downloads\ai_master\notebooks\ogenti_a100_scout.ipynb"
